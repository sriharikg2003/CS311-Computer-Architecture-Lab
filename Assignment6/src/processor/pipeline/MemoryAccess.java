...
// LOAD 
			if(OPCODE.equals("10110")){
				...
				System.out.println("will load at time  " + (		Clock.getCurrentTime() + Configuration.L1d_latency));
...
// STORE 
				...
				System.out.println("sendig memory store request for time  " + (		Clock.getCurrentTime() + Configuration.L1d_latency));
