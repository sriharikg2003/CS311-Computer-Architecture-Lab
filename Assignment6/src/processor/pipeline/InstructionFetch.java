	...
	public void handleEvent(Event e) {
		...
		if (IF_OF_Latch.isOF_busy()) {
			...
			if (Variables.ignore_instruction){
				...
				MemoryReadEvent myevent  = new MemoryReadEvent(Clock.getCurrentTime() + Configuration.L1i_latency, this,
				...
				System.out.println("Sending memory special read event "+myevent+ "request with time " +(Clock.getCurrentTime() + Configuration.L1i_latency));
	...
	public void performIF() {
		...
		if (IF_EnableLatch.isIF_enable()) {
			if (IF_EnableLatch.isIF_busy()) {
				...
				System.out.println("Sending memory read event "+myevent+ "request with time " +(Clock.getCurrentTime() + Configuration.L1i_latency));
				IF_EnableLatch.setIF_busy(true);
			}
